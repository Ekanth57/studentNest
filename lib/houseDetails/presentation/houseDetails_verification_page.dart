...
class HouseDetailsVerificationPage extends StatefulWidget {
  HouseDetailsVerificationPage(this.markedId);
  final String markedId;
  @override
  State<HouseDetailsVerificationPage> createState() => _HouseDetailsVerificationPageState();
}

class _HouseDetailsVerificationPageState extends State<HouseDetailsVerificationPage> {
                    ...
                    bottomNavigationBar: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          context
                              .read<HouseDetailsBloc>()
                              .add(HouseDetailsEvent.userType('admin'));
                          context
                              .read<HouseDetailsBloc>()
