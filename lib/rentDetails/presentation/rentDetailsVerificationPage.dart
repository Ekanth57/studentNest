...
class RentDetailsVerificationPage extends StatefulWidget {
  RentDetailsVerificationPage(this.markerId,);
  final String? markerId;
  @override
  State<RentDetailsVerificationPage> createState() => _RentDetailsVerificationPageState();
}

class _RentDetailsVerificationPageState extends State<RentDetailsVerificationPage> {
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              context.read<RentDetailsBloc>().add(RentDetailsEvent.userType('admin'));
