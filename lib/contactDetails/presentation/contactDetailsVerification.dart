...
class ContactDetailsVerificationPage extends StatefulWidget {
  ContactDetailsVerificationPage(this.markerId,);
  final String? markerId;
  @override
  State<ContactDetailsVerificationPage> createState() => _ContactDetailsVerificationPageState();
}

class _ContactDetailsVerificationPageState extends State<ContactDetailsVerificationPage> {
                    ...
                    bottomNavigationBar: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          context.read<ContactDetailsBloc>().add(ContactDetailsEvent.userType("admin"));
