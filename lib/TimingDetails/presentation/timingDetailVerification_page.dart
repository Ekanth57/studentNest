...
class TimingDetailsVerificationPage extends StatefulWidget {
  TimingDetailsVerificationPage(this.markerId,);
  final String? markerId;
  @override
  State<TimingDetailsVerificationPage> createState() => _TimingDetailsVerificationPageState();
}

class _TimingDetailsVerificationPageState extends State<TimingDetailsVerificationPage> {
        ...
        child: MultiBlocListener(
            ...
            child: BlocBuilder<TimingDetailsWatcherBloc,
              ...
              return state.map(
                ...
                loadSuccess: (state) {
                  print(state.timingDetailsDetails!.days);
                    ...
                    bottomNavigationBar: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          context.read<TimingDetailsBloc>().add(TimingDetailsEvent.userType('admin'));
