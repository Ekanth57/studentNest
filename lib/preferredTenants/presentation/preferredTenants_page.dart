...
class PreferredTenantsPage extends StatefulWidget {
  PreferredTenantsPage(this.markedId, this.houseDetailsObject);
  final String markedId;
  final HouseDetailsObject houseDetailsObject;
  @override
  State<PreferredTenantsPage> createState() => _PreferredTenantsPageState();
}

class _PreferredTenantsPageState extends State<PreferredTenantsPage> {
        ...
        child: MultiBlocListener(
            ...
            child: BlocBuilder<PreferredTenantsWatcherBloc,
              ...
              return state.map(
                ...
                loadSuccess: (state) {
                  for(int i =0;i<widget.houseDetailsObject.noOfRooms!;i++){
                    state.preferredTenantsObject!.universityList!.add('');
                  }
                    ...
                    bottomNavigationBar: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          context.read<PreferredTenantsBloc>().add(PreferredTenantsEvent.userType('user'));
